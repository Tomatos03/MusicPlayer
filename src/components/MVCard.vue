    ...
    <div class="mv-card"
        ...
        <div class="mv-img">
            ...
            <div class="watched-number">
                <i class="iconfont icon-play"></i>
                <span> {{ handleNum(props.mv.playTime || props.mv.playCount) }} </span>
            </div>
            <span class="duration">{{ handleMusicTime(props.mv.durationms || props.mv.duration) }}</span>
        </div>
...
<style scoped>
    ...
    .mv-img .duration{
        ...
        padding: 2px;
        font-size: .9em;
        background-color: rgba(92, 67, 67, .8);
        color: white;
    }
    .mv-img{
        position: relative;
